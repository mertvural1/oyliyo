...
export const ChoicesScreen = ({ choices, onUpdate, onAdd, onRemove, onBack, onPublish, publishing = false }: ChoicesScreenProps) => <div className="w-full max-w-3xl animate-in fade-in slide-in-from-bottom-3 duration-500">
  <div className="mb-4 flex items-center gap-3">
    <button className="inline-flex size-10 shrink-0 items-center justify-center rounded-xl bg-white text-[#262448] shadow-[0_5px_15px_rgba(60,45,120,.1)] transition hover:-translate-x-0.5" onClick={onBack} aria-label="Geri dön"><ArrowLeft size={18} /></button>
    <div className="flex-1 text-center">
      <h1 className="text-4xl font-extrabold tracking-[-.055em] sm:text-5xl">Cevap seçeneklerini <em className="not-italic text-[#5b2cff]">ekle.</em></h1>
    </div>
  </div>
